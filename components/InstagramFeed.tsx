...
export default function InstagramFeed() {
  const photos = CANDIDATES.filter((c) => publicAssetExists(c.src));
      ...
      {photos.map((photo) => (
        ...
        >
          <Image
            ...
            className="object-cover object-top grayscale contrast-[1.05] transition-transform duration-500 ease-out group-hover:scale-105"
          />
